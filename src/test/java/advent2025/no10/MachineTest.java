...
public class MachineTest {
    ...
    public void ShouldStartMachine_WhenPressingGoodButton() {
        var machine = new Machine(new LightDiagram(List.of(true)), List.of(new ButtonWiring(Set.of(0))));
    ...
    public void ShouldNotStartMachine_WhenPressingWrongButton() {
        var machine = new Machine(new LightDiagram(List.of(true, false)), List.of(new ButtonWiring(Set.of(1))));
